...
\prob{2}{Sourced problem}{To create a problem, simply input}
\vspace{-0.2cm}
\begin{verbatim}
...
\prob{3}{}{If you leave the `Source' argument empty, the parentheses will not appear.}

\req{6}{}{Using the command}
\vspace{-0.2cm}
\verb|\req|
...
\req{13}{Quotes}{Problem-set quotes, as we displayed earlier, can be created with the following command:}
\vspace{-0.2cm}
\begin{verbatim}
